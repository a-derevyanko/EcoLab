...
public class ReportUtils {
    ...
    public static <T, V> String getFromListOfList(List<List<V>> listOfList, int i, int j, String defaultValue) {
        return listOfList.size() > i ? String.valueOf(listOfList.get(i).get(j)) : defaultValue;
    }
}

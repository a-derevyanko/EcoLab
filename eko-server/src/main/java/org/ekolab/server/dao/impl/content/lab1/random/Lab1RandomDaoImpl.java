...
public class Lab1RandomDaoImpl extends Lab1DaoImpl<Lab1RandomData, Lab1Variant> implements Lab1RandomDao {
    private static final Lab1DataMapper<Lab1RandomData, Lab1Variant> RECORD_MAPPER = new Lab1DataMapper<Lab1RandomData, Lab1Variant>() {
        ...
        @Override
        protected Lab1RandomData createData() {
            return new Lab1RandomData();
        }
    };

    @Override
    protected Lab1DataMapper<Lab1RandomData, Lab1Variant> getLabMapper() {

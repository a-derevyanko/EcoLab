...
INSERT INTO lab_test_question (id, version, lab_number, question_title, question_number, point_count) VALUES
  (20, 0, 2, 'Основные понятия и характеристики шума', 1, 5),
  (21, 0, 2, 'Шумовое воздействие ТЭС на окружающую среду', 2, 6),
  (22, 0, 2, 'Расчет уровня шума от энергетических объектов', 3, 8),
  (23, 0, 2, 'Работа с шумомером Алгоритм-01', 4, 8),
  (24, 0, 2, 'Глушители шума энергетического оборудования', 5, 8),
  (25, 0, 2, 'Определение верхней/нижней границы для среднегеометрической частоты октавной полосы', 6, 9),
  (26, 0, 2, 'Расчет звуковой мощности агрегата', 7, 12),
  (27, 0, 2, 'Определение очередности шумоглушения', 8, 12),
  (28, 0, 2, 'Допустимое время нахождения в шумном помещении', 9, 16),
  (29, 0, 2, 'Влияние геометрических размеров помещения', 10, 16);
...
VALUES
  ...
  (27, 0, NULL,
   ...
   1,
   'int', NULL,
   '96-10*Math.log(830)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   ...
   2,
   'int', NULL,
   '96.2-10*Math.log(830)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   'на расстоянии 1 м составляет 96,2 дБ. Площадь измерительной поверхности ' ||
   ...
   3,
   'int', NULL,
   '96.2-10*Math.log(860)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   ...
   4,
   'int', NULL,
   '96.4-10*Math.log(830)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   ...
   5,
   'int', NULL,
   '96.6-10*Math.log(860)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   ...
   6,
   'int', NULL,
   '100-10*Math.log(840)/Math.log(10)'),
  (27, 0, NULL,
   'Уровень звуковой мощности от корпуса энергетического оборудования  ' ||
   ...
   6,
   'int', NULL,
   '102-10*Math.log(850)/Math.log(10)'),

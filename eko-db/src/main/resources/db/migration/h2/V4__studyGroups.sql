...
COMMENT ON COLUMN STUDY_TEAMS.name IS 'Номер студенческой бригады';
COMMENT ON COLUMN STUDY_TEAMS.group_id IS 'Идентификатор группы';
...
CREATE UNIQUE INDEX IX_STUDY_GROUP_TEACHERS
  ON STUDY_GROUP_TEACHERS (GROUP_ID, TEACHER_ID);

COMMENT ON TABLE STUDY_GROUP_TEACHERS IS 'Связь групп и преподавателей';
COMMENT ON COLUMN STUDY_GROUP_TEACHERS.id IS 'Идентификатор записи';
COMMENT ON COLUMN STUDY_GROUP_TEACHERS.version IS 'Версия изменений(контроль одновременного доступа)';
COMMENT ON COLUMN STUDY_GROUP_TEACHERS.GROUP_ID IS 'Идентификатор группы';
COMMENT ON COLUMN STUDY_GROUP_TEACHERS.TEACHER_ID IS 'Идентификатор преподавателя';

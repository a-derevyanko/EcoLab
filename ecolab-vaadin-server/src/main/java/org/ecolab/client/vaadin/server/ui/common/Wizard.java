...
public abstract class Wizard extends org.vaadin.teemu.wizards.Wizard implements View, WizardProgressListener {
    ...
    public void init() throws Exception {
        ...
        addStyleName(EcoLabTheme.PANEL_WIZARD);
        getFinishButton().addStyleName(EcoLabTheme.BUTTON_PRIMARY);
        getFinishButton().addStyleName(EcoLabTheme.BUTTON_TINY);
        getNextButton().addStyleName(EcoLabTheme.BUTTON_PRIMARY);
        getNextButton().addStyleName(EcoLabTheme.BUTTON_TINY);
        getBackButton().addStyleName(EcoLabTheme.BUTTON_PRIMARY);
        getBackButton().addStyleName(EcoLabTheme.BUTTON_TINY);

...
import org.ecolab.client.vaadin.server.dataprovider.StudentInfoDataProvider;
import org.ecolab.client.vaadin.server.dataprovider.StudentInfoFilter;
...
import org.ecolab.client.vaadin.server.ui.windows.NewLabeledItemWindow;
...
public class StudentsPanel extends BaseUsersPanel<StudentDataWindowSettings, StudentInfoFilter> {
    ...
    public void init() throws Exception {
       ...
       filters.addComponent(removeStudentTeamButton, 13, 0);
        ...
        addStudentGroupButton.setStyleName(EcoLabTheme.BUTTON_PRIMARY);
        ...
        removeStudentGroupButton.setStyleName(EcoLabTheme.BUTTON_DANGER);
        ...
        addStudentTeamButton.setStyleName(EcoLabTheme.BUTTON_PRIMARY);
        addStudentTeamButton.setEnabled(false);

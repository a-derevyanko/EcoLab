...
import org.ecolab.server.service.api.content.lab3.Lab3ChartType;
...
public class Lab3Step5 extends GridLayout implements LabWizardStep<Lab3Data, Lab3Variant> {
    ...
    public void init() {
        ...
        chartTypeLabel.setStyleName(EcoLabTheme.LABEL_BOLD);
        ...
        chartType.addStyleName(EcoLabTheme.COMBOBOX_TINY);

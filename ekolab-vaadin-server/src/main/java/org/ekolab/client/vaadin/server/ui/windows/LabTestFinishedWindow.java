...
public class LabTestFinishedWindow<T extends LabData<V>, V extends LabVariant> extends BaseEkoLabWindow<LabTestFinishedWindow.LabFinishedWindowSettings<T, V>> {

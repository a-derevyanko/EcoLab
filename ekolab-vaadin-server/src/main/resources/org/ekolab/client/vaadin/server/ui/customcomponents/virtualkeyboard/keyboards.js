...
var keyboard_human_names = 
{
		...
		'sv': 'Swedish',
		'fi': 'Finnish',
		'russian-qwerty': 'Русский'
};

/* Keyboards from https://github.com/Mottie/Keyboard */
var keyboard_names = [
	"{cplk} Albanian (qwerty):albanian-qwerty",
	"{cplk} Albanian (qwertz):albanian-qwertz",
	"{cplk} Arabic (azerty):arabic-azerty",
	"{cplk} Arabic (qwerty-1):arabic-qwerty-1",
	"{cplk} Arabic (qwerty-2):arabic-qwerty-2",
	"{cplk} Arabic (qwerty-3):arabic-qwerty-3",
	"{cplk} Arabic (qwerty-4):arabic-qwerty-4",
...
keyboards['albanian-qwerty'] = {
        'default' : [
            ...
            "{cplk} a s d f g h j k l ; \u00e7 # {enter}",
            "{shift} \\ z x c v b n m , . / {shift}",
            "{accept} {alt} {space} {alt} {cancel}"],
        'shift' : [
            '\u00ac ! " \u00a7 $ % ^ & * ( ) _ + {bksp}',
    ...
    keyboards['albanian-qwertz'] = {
        'default' : [
            ...
            "{cplk} a s d f g h j k l \u00eb [ ] {enter}",
    ...
    keyboards['arabic-azerty'] = {
        ...
        keyboards['catalan-qwerty'] = {
            'default' : [
                ...
                "{cplk} a s d f g h j k l \u00f1 \u0301 \u00e7 {enter}",
                "{shift} < z x c v b n m , . - {shift}",
                "{accept} {alt} {space} {alt} {cancel}"
            ],
            'shift' : [
                ...
                "{cplk} A S D F G H J K L \u00d1 \u0308 \u00c7 {enter}",
                "{shift} > Z X C V B N M ; : _ {shift}",
                "{accept} {alt} {space} {alt} {cancel}"
            ],
            'alt' : [
                '\\ \u007c @ # \u0303 5 \u00ac 7 8 9 0 \u0027 \u00a1 {bksp}',
                "{tab} q w \u20ac r t y u i o p [ ]",
                "{cplk} a s d f g h j k l \u00f1 { } {enter}",
                "{shift} \u007c z x c v b n m , . - {shift}",
                "{accept} {alt} {space} {alt} {cancel}"
            ],
            'alt-shift' : [
    ...
    keyboards['danish-qwerty'] = {
        'default' : [
            ...
            "{cplk} a s d f g h j k l \u00e6 \u00f8 ' {enter}",
            "{shift} < z x c v b n m , . - {shift}",
            "{accept} {alt} {space} {alt} {cancel}"
        ],
        'shift' : [
    ...
    keyboards['german-qwertz-2'] = {
        ...
        'shift' : [
            ...
            "{cplk} A S D F G H J K L \u00e9 \u00e0 \u00a3 {enter}",
            "{shift} > Y X C V B N M ; : _ {shift}",
            "{accept} {alt} {space} {alt} {cancel}"
        ],
        'alt' : [
            "\u00a7 \u007c @ # 4 5 \u00ac \u00a6 \u00a2 9 0 \u0301 \u0303 {bksp}",
            "{tab} q w \u20ac r t z u i o p [ ]",
            "{cplk} a s d f g h j k l \u00f6 { } {enter}",
            "{shift} \\ y x c v b n m , . - {shift}",
            "{accept} {alt} {space} {alt} {cancel}"
        ]
    };
   ...
   /* keyboards['hungarian-qwertz-1'] = {
		'default' : [
		     		...
		     		"{cplk} a s d f g h j k l é á {enter}",
    ...
    keyboards['hungarian-qwertz-2'] = {
		'default' : [
		     		...
		     		"{tab} q w e r t z u i o p ő ú",
		     		"{cplk} a s d f g h j k l é á ű {enter}",
		     		"{shift} í y x c v b n m , . - {shift}",
		     		"{accept} {alt} {space} {alt} {cancel}"
		     	],
		     	'shift' : [
    ...
    keyboards['portuguese-qwerty'] = {
        'default' : [
            "\u005C 1 2 3 4 5 6 7 8 9 0 \u0027 \u00ab {bksp}",
            "{tab} q w e r t y u i o p \u002b \u00b4",
            "{cplk} a s d f g h j k l \u00e7 \u00ba \u007e {enter}",
            "{shift} \u003c z x c v b n m \u002c \u002e \u002d {shift}",
        ...
        'shift' : [
            "\u007c \u0021 \u0022 \u0023 \u0024 \u0025 \u0026 \u002f \u0028 \u0029 \u003d \u003F \u00bb {bksp}",
            "{tab} Q W E R T Y U I O P \u002a \u0060",
            "{cplk} A S D F G H J K L \u00c7 \u00aa \u005e {enter}",
            "{shift} \u003e Z X C V B N M \u003b \u003a \u005f {shift}",
            "{cancel} {space} {alt} {combo} {accept}"
        ],
    // AltGr
    ...
    keyboards['russian-qwerty'] = {
        'default' : [
            ...
            "{cplk} \u0444 \u044b \u0432 \u0430 \u043f \u0440 \u043e \u043b \u0434 \u0436 \u044d {enter}",
    ...
    keyboards['spanish-qwerty'] = {
        ...
        'alt' : [
            ...
            "{cplk} a s d f g h j k l \u00f1 \u0302 \u0300 {enter}",
            "{shift} < z x c v b n m , . - {shift}",
            "{accept} {alt} {space} {alt} {cancel}"
        ],
        'alt-shift' : [
    ...
    keyboards['swedish-dvorak'] = {
        'default' : [
            ...
            "{cplk} a o e u i d h t n s - < {enter}",
        ...
        'shift' : [
            '\u00bd ! " # \u00a4 % & / ( ) = ? ` {bksp}',
            "{tab} \u00d6 \u00c5 \u00c4 P Y F G C R L Q ^",
            "{cplk} A O E U I D H T N S _ > {enter}",
            "{shift} * ; : J K X B M W V Z {shift}",
            "{accept} {alt} {space} {alt} {cancel}"
        ],
        'alt' : [
